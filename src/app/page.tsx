  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100 via-emerald-50 to-yellow-50 opacity-70" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm shadow-lg shadow-purple-500/10 border border-purple-200 rounded-full px-4 py-1.5 mb-6 animate-slide-up">
            ...
            <span className="text-sm font-bold bg-gradient-to-r from-purple-600 via-emerald-500 to-orange-500 bg-clip-text text-transparent">
          ...
          <p className="text-lg sm:text-2xl text-gray-500 max-w-2xl mx-auto mb-8 animate-slide-up leading-relaxed font-bold">
            by <span className="bg-gradient-to-r from-purple-600 to-emerald-500 bg-clip-text text-transparent">Anush</span>
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20">
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          <div className="flex items-center gap-3">
            <div className="gradient-primary rounded-xl p-2 text-white shadow-lg shadow-purple-500/20">
        ...
        {lectures && lectures.length > 0 ? (
          ...
          <div className="text-center py-16 sm:py-20 bg-white/80 backdrop-blur-sm rounded-3xl border-2 border-dashed border-purple-200 shadow-lg shadow-purple-500/5">
            <div className="gradient-primary inline-flex rounded-2xl p-4 text-white shadow-lg shadow-purple-500/20 mb-4">
